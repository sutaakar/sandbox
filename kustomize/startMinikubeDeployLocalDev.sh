...
kubectl wait --for=condition=available --timeout=120s deployment/event-bridge-shard-operator -n event-bridge-operator
kubectl wait --for=condition=available --timeout=120s deployment/event-bridge -n event-bridge-manager
